...
function _draw()
 ...
 if debugmouse and not debugmsgs then
  print("c "..cam.x.." "..cam.y)
...
function diag_draw()
 ...
 then
  local x,y=10,75
  local tx,ty=x+5,y+5
  rectfill(x,y,128-x,120,6)
  print(diagmsg,tx,ty,1)
  
  ty+=6 --newline
  for j=1,#diagopts do
   print(diagopts[j][1],tx+8,ty+6*j,1)
   if diagsel==j then
    spr(222,tx,ty-1+6*j)
   end
  end
...
function ask_dock(porti)
 diag_open(
  ...
  {
   {"yes",function() dock_at(porti) diag_close() end},
   {"no",diag_close}
  })
end
...

...

...

...

